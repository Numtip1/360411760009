...
public class Midterm_java1 {
    public static void main(String[] args) {
        Scanner scanner  = new Scanner (System.in);
        //input
        //number
        System.out.print("insert number0 : ");
        ...
        int number10=(number+number1+number2+number3+number4+number5+number6+number7+number8+number9);
        System.out.print(number+number1+number2+number3+number4+number5+number6+number7+number8+number9);
